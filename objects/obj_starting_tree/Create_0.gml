...
{
	instance_create_depth(x, y - sprite_get_height(spr_root_straight)*1.5, self.depth + 5, obj_root_straight, { image_angle: 90, image_xscale: 0.5, image_yscale: 0.5 })
...
{
	instance_create_depth(x - sprite_get_width(spr_root_straight)*1.5, y, self.depth + 5, obj_root_straight, { image_angle: 0, image_xscale: 0.5, image_yscale: 0.5 })
